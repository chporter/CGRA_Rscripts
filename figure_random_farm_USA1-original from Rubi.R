...
x<-read.csv("C:/CGRA_data/US data/Iowa/Maize/Generic Ames Maize/Summary/Summary_maize_CM2_all.csv",header=TRUE)
...
tnam<-c[1]#"Iowa maize - soil 1"###for Ames maize
...
dir<-"C:/CGRA_data/US data/Iowa/Maize/Generic Ames Maize/Summary/Summary_maize_CM2_all.jpg"
...
#####to export the figure as a file
dir<-"C:/CGRA_data/US data/Iowa/Maize/Generic Ames Maize/Summary/Summary_maize_CM2_all_weather.jpg"
jpeg(dir,res=300, width=7, height=11, unit="in")
#####
